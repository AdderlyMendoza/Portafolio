    ...
    return (
        <li className="mb-10 ml-6">
            <div>
                ...
                <time className="block mb-2 text-lg font-normal leading-none text-gray-400">
                    {empresa}
                </time>
                <time className="block mb-2 text-md font-normal leading-none text-gray-500">
                    {fecha}
                </time>
            </div>
            ...
            <div className="">
                <p className="mb-4 font-normal text-gray-500">
                    ...
                    {descripcion.map((linea, index) => (
                        <p key={index} className="mb-2 text-md text-gray-500">
                            {linea}
                        </p>
                    ))}
                </p>
